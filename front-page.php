<?php
/*
 * Template Name: 메인 페이지 (애니메이션 수정본)
 */
get_header(); 
?>
...
<section class="newsletter-section slide-in-left">
    <div class="container">
        <div class="category-title-wrap">
                ...
                <article class="newsletter-item">
                    <a href="<?php the_permalink(); ?>" class="newsletter-link">
                        <div class="newsletter-row">
                            ...
                            <div class="newsletter-date"><?php echo get_the_date(); ?></div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('scroll', function() {
    checkVisible(fadeUps);
    checkVisible(slideIns);
  });
